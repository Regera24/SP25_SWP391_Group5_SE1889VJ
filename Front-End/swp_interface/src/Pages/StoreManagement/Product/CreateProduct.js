  ...
  const handleCreateProduct = async (values) => {
    ...
    try {
      ...
      const newProductData = {
        ...
        storeID: storeID,
        storeDetailProductAttributeDTOList: values.storeDetailProductAttributeDTOList.map(id => ({ id })) ? values.storeDetailProductAttributeDTOList.map(id => ({ id })) : [],
        storeDetailZoneDTOList: values.storeDetailZoneDTOList.map(id => ({ id })) ? values.storeDetailZoneDTOList.map(id => ({id})) : []
      };
