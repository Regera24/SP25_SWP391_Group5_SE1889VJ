    ...
    return (
        <div>
            ...
            <Flex vertical gap="middle" align="flex-start">
                ...
                {/* Create Modal */}    
                <Modal title="Thêm mới thuộc tính sản phẩm" open={isCreateModalOpen} onCancel={() => setIsCreateModalOpen(false)} footer={null}>
                    <CreateProductAttribute onClose={() => setIsCreateModalOpen(false)} storeID={storeID.id} fetchAttributes={fetchAttributes} />
                </Modal>
                {/* Update Modal */}
                <Modal title="Cập nhật thuộc tính sản phẩm" open={isUpdateModalOpen} onCancel={() => setIsUpdateModalOpen(false)} footer={null}>
                    {selectedAttribute && (
