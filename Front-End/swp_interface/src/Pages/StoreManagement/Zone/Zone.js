...
const Zone = () => {
    ...
    const columns = [
        ...
        { title: 'Số Lượng', dataIndex: 'quantity', key: 'quantity', width: '10%', sorter: true },
        { title: 'Kích Thước', dataIndex: 'size', key: 'size', width: '10%', sorter: true },
        { title: 'Tạo Bởi', dataIndex: 'createdBy', key: 'createdBy', width: '10%' },
        {
            title: 'Tạo Lúc',
            dataIndex: 'createdAt',
            key: 'createdAt',
                            ...
                            <div className="zone-content">
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td>{selectedZone.quantity}</td>
                                    </tr>
                                    <tr>
                                        <td><strong>Kích Thước:</strong></td>
                                        <td>{selectedZone.size}</td>
                                    </tr>
                                    <tr>
