...
public class ZoneConverter {
    ...
    public StoreZoneDTO toStoreZoneDTO(Zone zone){
        StoreZoneDTO storeZoneDTO = modelMapper.map(zone, StoreZoneDTO.class);
        storeZoneDTO.setProductID(zone.getProduct().getId());
        storeZoneDTO.setStoreID(zone.getStore().getId());
        storeZoneDTO.setProductName(zone.getProduct().getName());
        storeZoneDTO.setCreatedAt(zone.getCreatedAt());
        storeZoneDTO.setUpdatedAt(zone.getUpdatedAt());
        return storeZoneDTO;
    }
}
